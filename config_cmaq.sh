...
#> Critical Folder Locations
 export CMAQ_HOME=/home/ubuntu/ALEA
 export CMAQ_REPO=/home/ubuntu/ALEA
...
#>  gfortran compiler............................................................
    gcc)
        ...
        export WRF_ARCH=34
        #> I/O API, netCDF, and MPI library locations
        export IOAPI_INCL_DIR=/opt/culinam/ioapi-3.2/Linux2_aarch64gfort11   #> I/O API include header files
        export IOAPI_LIB_DIR=/opt/culinam/ioapi-3.2/Linux2_aarch64gfort11   #> I/O API libraries
