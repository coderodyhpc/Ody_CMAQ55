...
#>  gfortran compiler............................................................
    gcc)
        ...
        export WRF_ARCH=34
        #> I/O API, netCDF, and MPI library locations
        export IOAPI_INCL_DIR=/opt/atrium/ioapi-3.2/Linux2_aarch64gfort15   #> I/O API include header files
        export IOAPI_LIB_DIR=/opt/atrium/ioapi-3.2/Linux2_aarch64gfort15   #> I/O API libraries
        ...
        export myFFLAGS="-ffixed-form -ffixed-line-length-132 -finit-character=32 -O3 -mcpu=neoverse-v3 -fallow-argument-mismatch -fallow-invalid-boz"
        export myFRFLAGS="-ffree-form -ffree-line-length-none -finit-character=32 -O3 -mcpu=neoverse-v3 -fallow-argument-mismatch -fallow-invalid-boz"
        export myCFLAGS="-O2"
